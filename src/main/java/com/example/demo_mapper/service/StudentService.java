...
import com.example.demo_mapper.mapper.StudentEntityMapper;
...
public class StudentService {
    ...
    public Student save(Student student) {
        ...
        StudentEntity studentEntity = StudentEntityMapper.fromStudent(student);
        StudentEntity savedEntity = studentRepository.save(studentEntity);

        // todo here we convert the StudentEntity to a Student domain object
        return StudentMapper.fromEntity(savedEntity);
    }
